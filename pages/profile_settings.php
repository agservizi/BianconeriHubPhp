            ...
            <div class="grid gap-5">
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    <div class="space-y-2">
                        ...
                        <input id="profile_location" type="text" name="location" maxlength="120" value="<?php echo htmlspecialchars($locationValue, ENT_QUOTES, 'UTF-8'); ?>" class="w-full rounded-2xl border border-white/15 bg-black/50 px-4 py-2.5 text-sm text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white" placeholder="Torino (TO)" list="profile_location_options" data-city-autocomplete data-city-autocomplete-source="assets/data/comuni.json" data-city-autocomplete-min="2" autocomplete="off">
                        <datalist id="profile_location_options"></datalist>
                    </div>
                    <div class="space-y-2">
