...
<section class="mx-auto max-w-6xl space-y-6 px-2 sm:px-4 lg:px-0">
    <div class="fan-card px-5 py-6 space-y-6">
        ...
        <form action="" method="get" class="flex flex-col gap-3 rounded-3xl border border-white/10 bg-black/40 p-4 sm:flex-row sm:items-center sm:gap-4">
            ...
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
                ...
                <?php if ($hasQuery): ?>
                    <a href="?page=profile_search" class="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 px-4 py-2 text-sm font-semibold text-white transition-all hover:bg-white hover:text-black">
                        Azzera
                    ...
                    <?php if ($prevPage || $nextPage): ?>
                        <div class="flex flex-wrap items-center justify-between gap-3 border-t border-white/10 pt-4 text-sm text-gray-400">
                            <div>
                                ...
                                ?>
                                    <a href="<?php echo $prevUrl; ?>" class="inline-flex items-center gap-2 rounded-full border border-white/20 px-4 py-2 text-sm font-semibold text-white transition-all hover:bg-white hover:text-black">
                            ...
                            <div>
                                ...
                                ?>
                                    <a href="<?php echo $nextUrl; ?>" class="inline-flex items-center gap-2 rounded-full border border-white/20 px-4 py-2 text-sm font-semibold text-white transition-all hover:bg-white hover:text-black">
                                        Pagina successiva
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
